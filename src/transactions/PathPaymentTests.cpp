...
assetToString(const Asset& asset)
{
    ...
    switch (asset.type())
    {
    case supernode::ASSET_TYPE_NATIVE:
        r = std::string{"XLM"};
        break;
    case supernode::ASSET_TYPE_CREDIT_ALPHANUM4:
        assetCodeToStr(asset.alphaNum4().assetCode, r);
        break;
    case supernode::ASSET_TYPE_CREDIT_ALPHANUM12:
...
TEST_CASE("pathpayment", "[tx][pathpayment]")
{
    ...
    {
        auto market = TestMarket{*app};
        // see https://github.com/supernode/supernode-core/pull/1239
        auto minimumAccount =
