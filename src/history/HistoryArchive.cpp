...
{
    return std::string("supernode-history.json");
}
...
HistoryArchiveState::HistoryArchiveState() : server(SUPERNODE_CORE_VERSION)
{
    uint256 u;
...
HistoryArchiveState::HistoryArchiveState(uint32_t ledgerSeq,
    ...
    : server(SUPERNODE_CORE_VERSION), currentLedger(ledgerSeq)
{
