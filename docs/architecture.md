...
Two slightly-obscurely-named components are:
  ...
  - SCP -- "SuperNode Consensus Protocol", the component implementing the
    [consensus algorithm](https://www.supernode.org/papers/supernode-consensus-protocol.pdf).
...
- Set of core validator nodes. Running supernode-core only. Tasked with:
...
- Set of public HTTP nodes. Not running supernode-core. Running
...
- (optional): Set of public validator nodes. Running supernode-core only. Tasked
with:
  ...
  - Basically just a supernode-network load balancer / firewall for public access,
