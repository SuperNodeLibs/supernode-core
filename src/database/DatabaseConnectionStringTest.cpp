          ...
          "[db][dbconnectionstring]")
{
    ...
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://password=abc dbname=supernode)") ==
                R"(postgresql://password=******** dbname=supernode)");
    }

    SECTION("password is removed if second")
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://dbname=supernode password=dbname)") ==
                R"(postgresql://dbname=supernode password=********)");
    }
    ...
    SECTION("quoted password is removed")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=supernode password='quoted password')") ==
            R"(postgresql://dbname=supernode password=********)");
    }
    ...
    SECTION("parameters after password remain unchanged")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=supernode password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname=supernode password=******** performance='as fast as possible')");
    }
    ...
    SECTION("dbname can be quored")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname='supernode with spaces' password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname='supernode with spaces' password=******** performance='as fast as possible')");
    }
