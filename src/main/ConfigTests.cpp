// Copyright 2016 SuperNode Development Foundation and contributors. Licensed
...
{
    Config c;
    std::vector<std::string> testFiles = {"supernode-core_example.cfg",
                                          "supernode-core_standalone.cfg",
                                          "supernode-core_testnet.cfg"};
