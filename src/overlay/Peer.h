             ...
             public NonMovableOrCopyable
{
  ...
  protected:
    ...
    void recvMessage(SuperNodeMessage const& msg);
    void recvMessage(AuthenticatedMessage const& msg);
    void recvMessage(xdr::msg_ptr const& xdrBytes);

    virtual void recvError(SuperNodeMessage const& msg);
    // returns false if we should drop this peer
    void noteHandshakeSuccessInPeerRecord();
    void recvAuth(SuperNodeMessage const& msg);
    void recvDontHave(SuperNodeMessage const& msg);
    void recvGetPeers(SuperNodeMessage const& msg);
    void recvHello(Hello const& elo);
    void recvPeers(SuperNodeMessage const& msg);

    void recvGetTxSet(SuperNodeMessage const& msg);
    void recvTxSet(SuperNodeMessage const& msg);
    void recvTransaction(SuperNodeMessage const& msg);
    void recvGetSCPQuorumSet(SuperNodeMessage const& msg);
    void recvSCPQuorumSet(SuperNodeMessage const& msg);
    void recvSCPMessage(SuperNodeMessage const& msg);
    void recvGetSCPState(SuperNodeMessage const& msg);
  ...
  public:
    ...
    void sendMessage(SuperNodeMessage const& msg);
