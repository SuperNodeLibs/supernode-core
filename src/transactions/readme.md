# Transactions
See [Concept documentation](https://www.supernode.org/developers/guides/concepts/transactions.html).

Anything that changes the ledger is called a _Transaction_.
Transactions have an arbitrary list of operations inside them.

See the "struct Transaction" definition in src/xdr/SuperNode-transaction.x
...
## List of operations
See `src/xdr/SuperNode-transaction.x` for a detailed list of all operations and results.
