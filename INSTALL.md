...
==================
These are intructions for building supernode-core from source. For a potentially quicker set up we also have supernode-core in a docker container: https://github.com/supernode/docker-supernode-core-horizon
...
- `git clone https://github.com/supernode/supernode-core.git`
- `cd supernode-core`
- `git submodule init`
