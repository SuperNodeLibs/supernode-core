...
/* SuperNodeValue is the value used by SCP to reach consensus on a given ledger
*/
...
struct LedgerHeader
{
    ...
    SuperNodeValue scpValue;   // what consensus agreed to
...
/* Ledger upgrades
note that the `upgrades` field from SuperNodeValue is normalized such that
