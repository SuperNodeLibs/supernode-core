...
void
save(Archive& ar, supernode::Upgrades::UpgradeParameters const& p)
{
    ar(make_nvp("time", supernode::VirtualClock::to_time_t(p.mUpgradeTime)));
...
template <class Archive>
void
load(Archive& ar, supernode::Upgrades::UpgradeParameters& o)
{
    time_t t;
    ar(make_nvp("time", t));
    o.mUpgradeTime = supernode::VirtualClock::from_time_t(t);
