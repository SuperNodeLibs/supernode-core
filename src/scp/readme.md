# SCP (SuperNode Consensus Protocol)
...
XDR, in the file [SuperNode-SCP.x](../xdr/SuperNode-SCP.x)

The `supernode-core` program has a single subclass of SCP called
...
For details of the protocol itself, see the [paper on SCP](https://www.supernode.org/papers/supernode-consensus-protocol.pdf).
