 ...
 * stored at .well-known/supernode-history.json as a JSON file.
 *
 ...
 *
 * While the _most recent_ checkpoint is in .well-known/supernode-history.json,
...
class HistoryManager
{
  public:
    ...
    // .well-known/supernode-history.json to it.
