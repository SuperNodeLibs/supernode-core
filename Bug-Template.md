...
*example: I tried to submit a transaction containing `createAccount` and then supernode-core crashed*
...
*log location is normally defined in your log file something like `supernode-core.log`*
