 ...
 * `SuperNodeMessage`, in the file src/xdr/SuperNode-overlay.x
 *
 ...
 *
 * The `SuperNodeMessage` union contains 3 logically distinct kinds of message:
 *
...
class OverlayManager
{
  public:
    ...
    // Herder.
    virtual void broadcastMessage(SuperNodeMessage const& msg,
                                  bool force = false) = 0;
    ...
    virtual void recvFloodedMsg(SuperNodeMessage const& msg,
                                Peer::pointer peer) = 0;
