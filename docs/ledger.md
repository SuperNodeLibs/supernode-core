...
- **Ledger**: A ledger is the state of the distributed SuperNode database at a
...
- **Ledger header**: The ledger's header contains meta data about the ledger,
  ...
  own hash. (See [`src/xdr/SuperNode-ledger.x`](/src/xdr/SuperNode-ledger.x))


`SuperNode-core` maintains the content of the latest ledger and of the ledger
...
performance needs.
 ...
 4. Finally, `supernode-core` can be configured to upload detailed historical
