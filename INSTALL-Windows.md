...
Note that you can (and should) install the Windows version of postgres even when running supernode-core from within WSL.


# Basic Installation

- `git clone PATH_TO_SUPERNODE_CORE`
- `git submodule init`
- `git submodule update`
- Open the solution `Builds\VisualStudio\supernode-core.sln`
